class Level extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('codey', 'assets/images/player/walking.png', {frameWidth: 65, frameHeight: 80})
    ...
    this.load.image('platform', 'assets/images/platforms/L1_P5.png');
  ...
  create() {
    ...
    gameState.player = this.physics.add.sprite(125, 110, 'codey')
